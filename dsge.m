...
oo_.steady_state( 7 ) = (M_.params(1)-M_.params(2)*M_.params(3)/M_.params(2)/(1+M_.params(3)/M_.params(2)))/(1-M_.params(1));
oo_.steady_state( 8 ) = M_.params(1)/(1-M_.params(1));
oo_.steady_state( 11 ) = M_.params(1)-1;
oo_.steady_state( 9 ) = 1;
oo_.steady_state( 12 ) = 1;
oo_.steady_state( 13 ) = 1;
oo_.steady_state( 1 ) = 0.336;
oo_.steady_state( 2 ) = 0.3254;
oo_.steady_state( 3 ) = 0.3254;
oo_.steady_state( 4 ) = 0.336;
if M_.exo_nbr > 0;
